...
if number_of_cols_current==number_of_cols_reference:
    if(reference_data.equals(current_data)):
        print("SUCCESS: Datasets have the same column lenght, have the same columns names and same column types.")
    else:
        print("ERROR: Datasets have the same column lenght, but do not have the same columns names and same column types.")
else:
    print("ERROR: Datasets do not have the same column lenght, so they cannot have the same column names and types.")
